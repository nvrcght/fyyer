...
def show_venue(venue_id):
  ...
  data3={
    "id": 3,
    "name": "Park Square Live Music & Coffee", #3
    ...
    "past_shows": [{
      "artist_id": 5,
      "artist_name": "Matt Quevedo", #3
      "artist_image_link": "https://images.unsplash.com/photo-1495223153807-b916f75de8c5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80",
      "start_time": "2019-06-15T23:00:00.000Z"
    }],
    "upcoming_shows": [{
      "artist_id": 6,
      "artist_name": "The Wild Sax Band", #4
...
def create_artist_submission():
  ...
  # TODO: modify data to be the data object returned from db insertion
  form = request.form
  init_args = {arg: form[arg] for arg in ['name', 'city', 'state', 'phone', 'genres']}
  ...
  # TODO seeking venue doesn't get sent

  print('getting data', form)
  # on successful db insert, flash success
  try:
    artist = Artist(**init_args)
